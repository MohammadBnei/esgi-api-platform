...
export function retrieveError(retrieveError) {
  return { type: 'DRUNK_UPDATE_RETRIEVE_ERROR', retrieveError };
}

export function retrieveLoading(retrieveLoading) {
  return { type: 'DRUNK_UPDATE_RETRIEVE_LOADING', retrieveLoading };
}

export function retrieveSuccess(retrieved) {
  return { type: 'DRUNK_UPDATE_RETRIEVE_SUCCESS', retrieved };
}
...
export function updateError(updateError) {
  return { type: 'DRUNK_UPDATE_UPDATE_ERROR', updateError };
}

export function updateLoading(updateLoading) {
  return { type: 'DRUNK_UPDATE_UPDATE_LOADING', updateLoading };
}

export function updateSuccess(updated) {
  return { type: 'DRUNK_UPDATE_UPDATE_SUCCESS', updated };
}
...
export function reset(eventSource) {
  return dispatch => {
    ...
    dispatch({ type: 'DRUNK_UPDATE_RESET' });
    dispatch(error(null));
...
export function mercureOpen(eventSource) {
  return { type: 'DRUNK_UPDATE_MERCURE_OPEN', eventSource };
}

export function mercureMessage(retrieved) {
  return dispatch => {
    if (1 === Object.keys(retrieved).length) {
      dispatch({ type: 'DRUNK_UPDATE_MERCURE_DELETED', retrieved });
      return;
    }

    dispatch({ type: 'DRUNK_UPDATE_MERCURE_MESSAGE', retrieved });
  };
}
